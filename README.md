...
A token is used to verify authentication on a server when submitting a request.

2. What steps can you take in your web apps to keep your data secure?

You can make sure the software is up to date, enforce a strong password policy, use encryption on login pages, and using a secure host to keep data secure.

3. Describe how web servers work.

Web servers store, process, and deliver web pages to users like how water flows through tubes. It is a constant circle of communication.
